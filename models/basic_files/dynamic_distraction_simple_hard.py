...
""" Dynamic Distraction Simple
"""

def dynamic_simple_hard_distraction_decoder(decoder_inputs,
                      initial_state,
  ...
  with variable_scope.variable_scope(
      scope or "dynamic_simple_hard_distraction_decoder", dtype=dtype) as scope:
    dtype = scope.dtype
...
def dynamic_simple_hard_distraction_decoder_wrapper(decoder_inputs,
                                initial_state,
                                distract_initial_state,
                                attention_states,
                                attention_states_query,
  ...
  with variable_scope.variable_scope(
    embedding_scope or "dynamic_simple_hard_distraction_decoder_wrapper", dtype=dtype,  reuse = True) as s1:
  ...
  with variable_scope.variable_scope(
    scope or "dynamic_simple_hard_distraction_decoder_wrapper", dtype =dtype) as scope:
    return dynamic_simple_hard_distraction_decoder(
        emb_inp,
...
def dynamic_simple_hard_distraction_seq2seq(encoder_inputs,
  ...
  """
  with variable_scope.variable_scope(
      scope or "dynamic_simple_hard_distraction_seq2seq", dtype=dtype) as scope:
    dtype = scope.dtype
    # Encoder.
