...
def dynamic_distraction_m2_decoder_wrapper(decoder_inputs,
  ...
  with variable_scope.variable_scope(
    embedding_scope or "dynamic_distraction_m2_decoder_wrapper", dtype=dtype,  reuse = True) as s1:
  ...
  with variable_scope.variable_scope(
    scope or "dynamic_distraction_m2_decoder_wrapper", dtype =dtype) as scope:
...
def dynamic_distraction_m2_seq2seq(encoder_inputs,
  ...
  """
  with variable_scope.variable_scope(
      scope or "dynamic_distraction_m2_seq2seq", dtype=dtype) as scope:
    dtype = scope.dtype
    # Encoder.
    ...
    def decoder(feed_previous_bool):
      ...
      with variable_scope.variable_scope(
        ...
        outputs, state, ctx_vec = dynamic_distraction_m2_decoder_wrapper(
            decoder_inputs,
            initial_state=encoder_state,
